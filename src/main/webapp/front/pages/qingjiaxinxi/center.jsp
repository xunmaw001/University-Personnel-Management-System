				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="qingjiariqi" id="qingjiariqi" placeholder="请假日期" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">请假天数</label>
							<div class="layui-input-block">
								<input type="text" name="qingjiatianshu" id="qingjiatianshu" placeholder="请假天数" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">结束日期</label>
							<div class="layui-input-block">
								<input type="text" name="jieshuriqi" id="jieshuriqi" placeholder="结束日期" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">请假内容</label>
							<div class="layui-input-block">
								<input type="text" name="qingjianeirong" id="qingjianeirong" placeholder="请假内容" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
