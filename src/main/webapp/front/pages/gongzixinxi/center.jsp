				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="jibengongzi" id="jibengongzi" placeholder="基本工资" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">加班工资</label>
							<div class="layui-input-block">
								<input type="text" name="jiabangongzi" id="jiabangongzi" placeholder="加班工资" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">补贴</label>
							<div class="layui-input-block">
								<input type="text" name="butie" id="butie" placeholder="补贴" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">社保</label>
							<div class="layui-input-block">
								<input type="text" name="shebao" id="shebao" placeholder="社保" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">伙食</label>
							<div class="layui-input-block">
								<input type="text" name="huoshi" id="huoshi" placeholder="伙食" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">其他扣费</label>
							<div class="layui-input-block">
								<input type="text" name="qitakoufei" id="qitakoufei" placeholder="其他扣费" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                                                                                        <div class="layui-form-item">
