				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('nianjiaxinxi','调休申请')" @click="onAcrossTap('nianjiadiaoxiu')" type="button" class="layui-btn">
								调休申请
							</button>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`nianjiaxinxi`);
