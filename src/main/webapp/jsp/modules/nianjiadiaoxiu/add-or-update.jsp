								...
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
										...
										<input id="mingcheng" name="mingcheng" class="form-control" placeholder="名称">
											...
											<div class="form-group col-md-6">
										<label>调休内容</label>
										<textarea name="diaoxiuneirong" class="form-control" id="diaoxiuneirong" rows="3"></textarea>
									</div>
											<div class="form-group col-md-6">
										<label>申请日期</label>
	...
	<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/resources/js/datetimepicker/bootstrap-datetimepicker.min.js"></script>
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("nianjiadiaoxiu/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function dataBind(){
			$("#updateId").val(ruleForm.id);	
												$("#mingcheng").val(ruleForm.mingcheng);	
																$("#diaoxiuneirong").val(ruleForm.diaoxiuneirong);
				...
				http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
												...
												if(res.data != null && res.data != '' && res.data.diaoxiuneirong != null && res.data.diaoxiuneirong != ''){

															$("#diaoxiuneirong").val(res.data.diaoxiuneirong);
													}
