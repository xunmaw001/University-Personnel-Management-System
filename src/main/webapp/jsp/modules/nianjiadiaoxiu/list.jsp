...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">年假调休管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">年假调休列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">年假调休列表</h3>							
	...
	<script>
			...
			row.appendChild(checkbox)
							...
							var mingchengCell  = document.createElement('td');
									...
									row.appendChild(mingchengCell);
				            				var diaoxiuneirongCell  = document.createElement('td');

												  if(item.diaoxiuneirong != null && item.diaoxiuneirong != "" && item.diaoxiuneirong.length >= 11){
				  	diaoxiuneirongCell.innerHTML = item.diaoxiuneirong.substring(0, 10) + "..."; 
				  }else{
				  	diaoxiuneirongCell.innerHTML = item.diaoxiuneirong;
				  }

				
									row.appendChild(diaoxiuneirongCell);
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("nianjiadiaoxiu/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("nianjiadiaoxiu/update","POST",data,(res)=>{
				if(res.code == 0){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("nianjiadiaoxiu/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function getSum(colName){
			http("nianjiadiaoxiu"+colName,"GET",{
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"nianjiadiaoxiu");
