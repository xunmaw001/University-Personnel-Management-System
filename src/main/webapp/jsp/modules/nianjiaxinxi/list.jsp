...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">年假信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">年假信息管理</li>
								<li class="breadcrumb-item active">年假信息列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">年假信息列表</h3>							
												...
												<div class="custom-control custom-checkbox">
													...
													<label class="custom-control-label" for="select-all"></label>
																																						...
																																						<th onclick="sort('mingcheng')">名称<i id="mingchengIcon" class="fa fa-sort"></i></th>
																																																			...
																																																			<th onclick="sort('nianjiatianshu')">年假天数<i id="nianjiatianshuIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			row.appendChild(checkbox)
							...
							var mingchengCell  = document.createElement('td');
									...
									row.appendChild(xingmingCell);
				            				var nianjiatianshuCell  = document.createElement('td');

												 nianjiatianshuCell.innerHTML = item.nianjiatianshu;

				
									row.appendChild(nianjiatianshuCell);
            ...
            crossBtn1.innerHTML = "调休申请"
			crossBtn1.setAttribute("type","button");
			crossBtn1.setAttribute("class","btn btn-primary btn-sm");
			crossBtn1.setAttribute("onclick","crossTable(" + item.id + ",\"nianjiadiaoxiu\")");
			if(crossBtnControl('调休申请') == true){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("nianjiaxinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"nianjiaxinxi");
