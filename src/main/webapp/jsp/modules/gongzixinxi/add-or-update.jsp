					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">编辑工资信息</li>
							</ol>
						</div>
					</div>
				</div>
								...
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
										...
										<input id="butie" name="butie" class="form-control" onchange="calculation()">
											...
											<div class="form-group col-md-6">
										<label>社保</label>
										<input id="shebao" name="shebao" class="form-control" onchange="calculation()">
									</div>	
											<div class="form-group col-md-6">
										<label>伙食</label>
										<input id="huoshi" name="huoshi" class="form-control" onchange="calculation()">
									</div>	
											<div class="form-group col-md-6">
										<label>其他扣费</label>
										<input id="qitakoufei" name="qitakoufei" class="form-control" onchange="calculation()">
									</div>	
											<div class="form-group col-md-6">
										<label>实发工资</label>
		...
		function calculation(){
			...
			var flag = 0;
								...
								y = y + parseFloat($("#butie").val());
																								...
																								if($("#shebao").val() != null && $("#shebao").val() != ""){
								y = y - parseFloat($("#shebao").val());
							}
																								if($("#huoshi").val() != null && $("#huoshi").val() != ""){
								y = y - parseFloat($("#huoshi").val());
							}
																								if($("#qitakoufei").val() != null && $("#qitakoufei").val() != ""){
								y = y - parseFloat($("#qitakoufei").val());
							}
																																						$("#shifagongzi").val(y);
																}		
		...
		function dataBind(){
			$("#updateId").val(ruleForm.id);	
												$("#mingcheng").val(ruleForm.mingcheng);	
																...
																$("#shebao").val(ruleForm.shebao);	
																$("#huoshi").val(ruleForm.huoshi);	
																$("#qitakoufei").val(ruleForm.qitakoufei);	
				...
				http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
												...
												if(res.data != null && res.data != '' && res.data.shebao != null && res.data.shebao != ''){

															$("#shebao").val(res.data.shebao);
													}
												if(res.data != null && res.data != '' && res.data.huoshi != null && res.data.huoshi != ''){

															$("#huoshi").val(res.data.huoshi);
													}
												if(res.data != null && res.data != '' && res.data.qitakoufei != null && res.data.qitakoufei != ''){

															$("#qitakoufei").val(res.data.qitakoufei);
													}
