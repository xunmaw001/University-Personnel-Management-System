...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">工资信息统计</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">工资信息统计</li>
							</ol>
						</div>
					</div>
				</div>
	...
	$.ajax({ 
		type: "GET",
		url: baseUrl+"value/gongzixinxi/"+xColumnName+'/'+yColumnName,
		data:{ },
	...
	function group(colName){
		$.ajax({ 
			type: "GET",
			url: baseUrl+"group/gongzixinxi/"+colName,
			data:{	tableName: "gongzixinxi",
					columnName: colName
					},
			beforeSend: function(xhr) {
				xhr.setRequestHeader("token", window.sessionStorage.getItem('token'));
