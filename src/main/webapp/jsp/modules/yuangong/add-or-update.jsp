								...
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
										...
										<input id="shenfenzheng" name="shenfenzheng" class="form-control" placeholder="身份证">
											...
											<div class="form-group col-md-6">
										<label>住址</label>
										<input id="zhuzhi" name="zhuzhi" class="form-control" placeholder="住址">
									</div>
					...
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
								...
								$("#touxiang-input").val(res.data.touxiang);
												...
												if(res.data != null && res.data != '' && res.data.zhuzhi != null && res.data.zhuzhi != ''){

															$("#zhuzhi").val(res.data.zhuzhi);
													}
											}
				});  
            }
