												...
												<div class="custom-control custom-checkbox">
													...
													<label class="custom-control-label" for="select-all"></label>
																													...
																													<th>头像</th>
																																																			...
																																																			<th onclick="sort('zhuzhi')">住址<i id="zhuzhiIcon" class="fa fa-sort"></i></th>
																																					<th>操作</th>
										</tr>
									</thead>
									<tbody>
			...
			row.appendChild(checkbox)
				  ...
				  touxiangCell.appendChild(touxiangImg);
									...
									row.appendChild(shenfenzhengCell);
				            				var zhuzhiCell  = document.createElement('td');

												 zhuzhiCell.innerHTML = item.zhuzhi;

				
									row.appendChild(zhuzhiCell);
